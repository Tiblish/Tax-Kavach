...
export default function GSTServicesPage() {
  ...
  return (
    <main className="min-h-screen bg-brand-light">
      ...
      {/* Hero — White surface on brand-light base */}
      <section className="relative py-20 lg:py-32 overflow-hidden bg-white">
        <div className="absolute inset-0 opacity-[0.02]" style={{ backgroundImage: 'radial-gradient(circle, #003366 1px, transparent 1px)', backgroundSize: '32px 32px' }}></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center lg:text-left">
          <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
            <div className="lg:col-span-7">
               <div className="inline-flex items-center px-4 py-2 rounded-full bg-brand-blue/5 border border-brand-blue/10 text-brand-blue text-[10px] font-bold uppercase tracking-widest mb-6">
            ...
            <div className="lg:col-span-5 mt-16 lg:mt-0">
               <div className="relative group">
                  <div className="absolute -inset-4 bg-brand-blue/[0.03] rounded-4xl blur-2xl group-hover:bg-brand-blue/[0.06] transition-all duration-500"></div>
                  <div className="relative bg-white p-2 rounded-4xl border border-slate-100/80 overflow-hidden shadow-elevation-hero">
                     <div className="aspect-square bg-gradient-to-br from-brand-light to-white flex items-center justify-center p-12 rounded-3xl">
                        <svg className="w-full h-full text-brand-blue/[0.07]" fill="currentColor" viewBox="0 0 24 24">
      ...
      {/* Core GST Domains — brand-light base with white elevated cards */}
      <section className="py-24 lg:py-30 bg-brand-light relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-heading font-black text-brand-blue uppercase tracking-tight mb-3">Core GST Domains</h2>
            <p className="text-brand-grey font-medium text-body-lg">Comprehensive protection across all departmental touchpoints.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-8 lg:p-10 rounded-3xl border border-slate-100/80 shadow-elevation-1 card-interactive">
              ...
              <h3 className="text-heading-sm font-bold text-brand-blue mb-4">Compliance & Filing</h3>
            ...
            <div className="bg-white p-8 lg:p-10 rounded-3xl border border-slate-100/80 shadow-elevation-1 card-interactive">
              ...
              <h3 className="text-heading-sm font-bold text-brand-blue mb-4">Forensic & Audit</h3>
              <ul className="space-y-3 text-brand-grey font-medium text-body">
            ...
            <div className="bg-white p-8 lg:p-10 rounded-3xl border border-slate-100/80 shadow-elevation-1 card-interactive">
              ...
              <h3 className="text-heading-sm font-bold text-brand-blue mb-4">Litigation Support</h3>
              <ul className="space-y-3 text-brand-grey font-medium text-body">
      ...
      {/* Insider Edge — Deep brand-blue surface with gradient overlay */}
      <section className="py-24 lg:py-30 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-brand-blue to-brand-blue-dark rounded-4xl p-10 lg:p-20 relative overflow-hidden shadow-[0_40px_80px_-20px_rgba(0,51,102,0.3)]">
