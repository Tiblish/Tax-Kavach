...
export default function TrainingPage() {
  return (
    <main className="min-h-screen bg-warm-100">
      ...
      {/* Academy Hero Section — Navy gradient with crimson accents */}
      <section className="relative pt-32 pb-20 lg:pt-44 lg:pb-32 overflow-hidden bg-gradient-to-br from-brand-navy to-brand-navy-dark">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#courses" className="bg-brand-crimson text-white px-10 py-4 rounded-xl font-bold text-base uppercase tracking-tight hover:bg-brand-crimson-dark transition-all shadow-2xl min-h-[52px] flex items-center justify-center hover:-translate-y-1">
              Explore Modules
            </a>
            <a href="#enroll" className="bg-transparent text-white border-2 border-white/20 px-10 py-4 rounded-xl font-bold text-base uppercase tracking-tight hover:bg-white/5 transition-all min-h-[52px] flex items-center justify-center hover:-translate-y-1">
      ...
      <section id="courses" className="py-24 lg:py-30 bg-white relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-heading font-black text-brand-navy uppercase tracking-tight mb-3">The Academy Protocol</h2>
            <p className="text-warm-600 font-medium text-body-lg">Systematic training paths for every stage of your career.</p>
          </div>
      ...
      <section className="py-24 lg:py-30 bg-warm-100 relative overflow-hidden">
        <div className="section-divider"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
            <div className="lg:col-span-6 mb-12 lg:mb-0">
               <div className="relative p-2 bg-white rounded-4xl shadow-elevation-hero overflow-hidden">
                  <div className="aspect-video bg-gradient-to-br from-brand-navy to-brand-navy-dark rounded-3xl flex items-center justify-center p-16 text-white/10 relative">
                     {/* Crimson accent bar */}
                     <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-brand-crimson to-brand-accent"></div>
            ...
            <div className="lg:col-span-6">
              ...
              <h2 className="text-heading lg:text-heading-lg font-black text-brand-navy mb-6 leading-tight uppercase tracking-tight">
                Natural Acquisition <br />of Tax Logic.
              </h2>
              <div className="space-y-6 text-warm-600 font-medium text-body-lg leading-relaxed">
                <p>
                  At Tax Kavach, we don&apos;t believe in rote memorization of sections. Our methodology focuses on <strong className="text-brand-navy">Direct Object-to-Word Association</strong> with the actual GST portal.
                </p>
                <p>
                ...
                <div className="pt-4 flex gap-10">
                   <div className="flex flex-col">
                      <span className="text-3xl font-black text-brand-crimson">90%</span>
                      <span className="text-xs font-bold uppercase tracking-widest text-warm-500 mt-1">Practical Labs</span>
                   </div>
                   <div className="flex flex-col">
                      <span className="text-3xl font-black text-brand-crimson">Expert</span>
                      <span className="text-xs font-bold uppercase tracking-widest text-warm-500 mt-1">Led Coaching</span>
                   </div>
                </div>
              </div>
            </div>
      ...
      {/* Enrollment Form — White surface with clear CTA */}
      ...
      {/* Trust Footer — Navy gradient with crimson accent */}
      <section className="bg-gradient-to-br from-brand-navy to-brand-navy-dark py-16 lg:py-20 text-center relative overflow-hidden">
        <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-brand-crimson via-brand-accent to-brand-crimson"></div>
        ...
        <div className="max-w-3xl mx-auto px-4 relative z-10">
           ...
           <div className="w-12 h-1 bg-brand-crimson/40 mx-auto mt-8 rounded-full"></div>
        </div>
      </section>
    </main>
  );
