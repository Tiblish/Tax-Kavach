...
export default function Home() {
  return (
    <main className="min-h-screen bg-warm-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-6">
            <div>
              ...
              <h2 className="text-heading font-black text-brand-navy tracking-tight">Tax Insights</h2>
              <p className="mt-3 text-warm-600 font-medium max-w-xl text-body-lg">
                Direct analysis from our team of GST and Income Tax experts.
              </p>
            </div>
            <Link href="/resources" className="group text-brand-crimson font-bold flex items-center hover:text-brand-crimson-dark transition-colors text-sm uppercase tracking-wider">
              View All Insights
      ...
      {/* Trust & Authority Banner — Navy gradient with crimson accents */}
      <section className="bg-gradient-to-br from-brand-navy to-brand-navy-dark py-20 lg:py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link 
              ...
              className="bg-brand-crimson text-white px-10 py-4 rounded-xl font-bold text-base hover:bg-brand-crimson-dark transition-all uppercase tracking-tight shadow-2xl min-h-[52px] flex items-center justify-center hover:-translate-y-1"
            >
              Schedule a Secure Audit
            </Link>
            <Link 
              href="/admin" 
              className="bg-transparent text-white border-2 border-white/20 px-10 py-4 rounded-xl font-bold text-base hover:bg-white/10 transition-all uppercase tracking-tight min-h-[52px] flex items-center justify-center hover:-translate-y-1"
            >
              Manage Content
            </Link>
          </div>
